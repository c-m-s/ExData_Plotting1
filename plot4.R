...
plot4 <- function() {
        ...
        if(!file.exists("./household_power_consumption.txt")) {
                ...
                # R manual recommends on MacOS to call unzip with full path.
                unzip("./household_power_consumption.zip", unzip="/usr/bin/unzip",exdir = "./")        
        }
        ...
        powerdata2days <- powerdata[powerdata$Date == as.Date("2007-02-01") | powerdata$Date == as.Date("2007-02-02"),]
        ...
        plot(powerdata2days$datetime, powerdata2days$Global_active_power, type="l", 
             xlab="", ylab="Global Active Power")
        
        # sub-plot 2
        # generate the plot into the open png graphics device
        plot(powerdata2days$datetime, powerdata2days$Sub_metering_1, type="l", 
        ...
        # sub-plot 3
        # generate the plot into the open png graphics device
        plot(powerdata2days$datetime, powerdata2days$Voltage, type="l", 
             xlab="datetime", ylab="Voltage")
        
        # sub-plot 4
        # generate the plot into the open png graphics device
        plot(powerdata2days$datetime, powerdata2days$Global_reactive_power, type="l", 
